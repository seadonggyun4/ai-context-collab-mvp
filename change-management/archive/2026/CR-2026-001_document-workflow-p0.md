...
| 우선순위 | 문서 | 적용 범위 | 확인 결과 |
| --- | --- | --- | --- |
| 1 | `organization-standards/*.md` | 역할별 문서 작성과 QA 원칙 | 확인 완료 |
...
| `organization-standards/qa-standards.md` | 증거·미실행·재검증 원칙 추가 | 수정 |
...
| `organization-standards/qa-standards.md` | 증거 상태와 재검증 원칙 추가 | 계획됨 |
