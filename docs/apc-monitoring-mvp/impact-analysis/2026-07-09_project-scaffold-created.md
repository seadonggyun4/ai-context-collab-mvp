...
`projects/apc-monitoring-mvp/` 하위에 Vite React, Python FastAPI, Vercel 배포를 위한 기본 scaffold를 생성했다.
...
| `projects/apc-monitoring-mvp/docs/phase-plan.md` | 현재 상태를 Phase 1 완료로 갱신 |
| `projects/apc-monitoring-mvp/docs/local-development.md` | 로컬 실행 기준 추가 |
| `projects/apc-monitoring-mvp/vercel.json` | Vercel 배포 기준 추가 |
...
- Vercel project root를 `projects/apc-monitoring-mvp/`으로 두는 배포 기준이 생성됨
