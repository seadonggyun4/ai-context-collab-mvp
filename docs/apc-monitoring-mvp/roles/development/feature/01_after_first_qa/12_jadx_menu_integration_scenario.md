...
현재 `projects/apc-monitoring-mvp/`은 문서 시연용 독립 MVP이며 실제 `/Users/dgseo/Desktop/JADX/...` 코드베이스를 수정하지 않는다.
...
| --- | --- |
| 구현 일자 | 2026-07-09 |
| 메뉴 shell | `projects/apc-monitoring-mvp/frontend/src/features/monitoring/pages/ApcDataManagementShell.tsx` |
| 데이터 조회 | `projects/apc-monitoring-mvp/frontend/src/features/data-lookup-integration/DataLookupIntegrationPage.tsx` |
| 시각화 | `projects/apc-monitoring-mvp/frontend/src/features/visualization-integration/VisualizationIntegrationPage.tsx` |
