...
| --- | --- |
| 구현 일자 | 2026-07-09 |
| 대상 화면 | `app/frontend/src/features/monitoring/pages/QualityIssuesPage.tsx` |
| 스타일 기준 | `app/frontend/src/shared/styles/global.css` |
| Fixture | `app/shared/fixtures/monitoring_fixture.json`에 MVP 기준 6개 이슈 유형 보강 |
| API 계약 테스트 | `app/api/tests/test_monitoring_api.py`에 전체 이슈 유형 coverage 테스트 추가 |
